...
+ Revision: 305048
- add source and spec
- Created package structure for koffice-l10n-it.
...
- bah, fix buildrequires for real

* Sun Apr 18 2004 Per Øyvind Karlsen <peroyvind@linux-mandrake.com> 1.3-1mdk
- 1.3
- fix buildrequires
- spec cosmetics
